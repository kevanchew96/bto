...
addMarkers(data=df,~lon,~lat, popup= ~`Town.Estate`, label = ~Month.of.Launch, icon=makeIcon("House.png",iconWidth = 12, iconHeight =12), group="BTOcurrent") #%>% # image source: https://pixabay.com/vectors/house-icon-home-symbol-sign-308936/ addLayersControl(overlayGroups=c("Schools","Parks","BTOcurrent")) #%>% addCircleMarkers(parents house)
# image source: https://pixabay.com/vectors/house-door-f-house-facade-entry-2277025/
```
```{r}
